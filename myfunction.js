      ...
      async function handleFormSubmit(form, resultEl){
        ...
        if (form.id === "msgFormAnon") {
          ...
          if (!recipient.value.trim()) {
            ...
            recipient.insertAdjacentHTML('afterend', '<div class="error-text">Recipient link is required.</div>');
            if (valid) recipient.focus();
            valid = false;
          }
          if (!message.value.trim()) {
            message.classList.add("error");
            message.insertAdjacentHTML('afterend', '<div class="error-text">Message is required.</div>');
          ...
          for (const r of required){
            if (!r.value.trim()){
              ...
              r.insertAdjacentHTML('afterend', '<div class="error-text">This field is required.</div>');
              if (valid) r.focus();
              valid = false;
            }
          }
